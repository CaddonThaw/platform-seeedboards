...
def _get_board_memory_type(env):
    # print("in main py _get_board_memory_type")
...
def _normalize_frequency(frequency):
    # print("in main py _normalize_frequency")
    frequency = str(frequency).replace("L", "")
    return str(int(int(frequency) / 1000000)) + "m"


def _get_board_f_flash(env):
    # print("in main py _get_board_f_flash")
    frequency = env.subst("$BOARD_F_FLASH")
    return _normalize_frequency(frequency)


def _get_board_f_image(env):
    # print("in main py _get_board_f_image")
    board_config = env.BoardConfig()
...
def _get_board_f_boot(env):
    # print("in main py _get_board_f_boot")
    board_config = env.BoardConfig()
...
def _get_board_boot_mode(env):
    # print("in main py _get_board_boot_mode")
...
def _parse_partitions(env):
    # print("in main py _parse_partitions")
...
def _update_max_upload_size(env):
    # print("in main py _update_max_upload_size")
...
def _to_unix_slashes(path):
    # print("in main py _to_unix_slashes")
    return path.replace("\\", "/")
...
def fetch_fs_size(env):
    # print("in main py fetch_fs_size")
    fs = None
...
def __fetch_fs_size(target, source, env):
    # print("in main py __fetch_fs_size")
    fetch_fs_size(env)
...
# print("CC:", env["CC"])
# print("CXX:", env["CXX"])
# print("OBJCOPY:", env["OBJCOPY"])
# print("RANLIB:", env["RANLIB"])
# print("UPLOADER:", env["UPLOADER"])
# print("UPLOADCMD:", env["UPLOADCMD"])

# print("ARFLAGS:", env["ARFLAGS"])
# print("ASFLAGS:", env["ASFLAGS"])
